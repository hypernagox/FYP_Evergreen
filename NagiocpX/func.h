...
namespace NagiocpX
{
	...
	constexpr inline const uint16 etoi(const T eType_)noexcept { return static_cast<const uint16>(eType_); }
	...
	//{
	//	return { c2s_PacketHandler::MakeSendBuffer(pkt_),NagiocpX::Session::GetID(pSendSession_) };
	//}
	//
