...
namespace NagiocpX
{
	...
	private:
		NagiocpX::VectorSetUnsafe<std::pair<uint32_t, const ContentsEntity*>> m_view_list_session{ DEFAULT_MEM_POOL_SIZE };
		NagiocpX::VectorSetUnsafe<const ContentsEntity*> m_view_list_npc{ DEFAULT_MEM_POOL_SIZE };
	private:
