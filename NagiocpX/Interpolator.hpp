...
namespace NagiocpX
{
    ...
    {
    public:
        constexpr static const uint64 GetTimeStampMilliseconds()noexcept { return NagiocpX::GetTimeStampMilliseconds(); }
        constexpr static const float GetTimeStampSeconds()noexcept { return NagiocpX::GetTimeStampSeconds(); }
    public:
