...
public:
	...
	const bool BindParam(c_int32 paramIndex, int8_t* const value, SQLLEN* const index)const noexcept;
	const bool BindParam(c_int32 paramIndex, int16_t* const value, SQLLEN* const index)const noexcept;
	const bool BindParam(c_int32 paramIndex, int32_t* const value, SQLLEN* const index)const noexcept;
	const bool BindParam(c_int32 paramIndex, int64_t* const value, SQLLEN* const index)const noexcept;
	...
	const bool BindParam(c_int32 paramIndex, std::byte* const bin, int32_t size, SQLLEN* const index)const noexcept;
	...
	const bool BindCol(c_int32 columnIndex, int8_t* const value, SQLLEN* const index)const noexcept;
	const bool BindCol(c_int32 columnIndex, int16_t* const value, SQLLEN* const index)const noexcept;
	const bool BindCol(c_int32 columnIndex, int32_t* const value, SQLLEN* const index)const noexcept;
	const bool BindCol(c_int32 columnIndex, int64_t* const value, SQLLEN* const index)const noexcept;
