...
namespace ServerCore
{
	...
	protected:
		...
		virtual ServerCore::ROUTINE_RESULT Routine()noexcept = 0;
		virtual void ProcessRemove()noexcept = 0;
	private:
		void StartTimer()noexcept;
		virtual void Dispatch(ServerCore::IocpEvent* const iocpEvent_, c_int32 numOfBytes)noexcept override final;
	private:
