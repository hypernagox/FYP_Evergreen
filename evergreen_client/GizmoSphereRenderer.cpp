...
static constexpr char g_psoResource[] = R"(
	...
	static float3 gVertexData[18] = 
	{
		...
		float3(-0.707f, 0.0f, 0.707f),
		float3(0.707f, 0.0f, 0.707f),
		float3(0.0f, -0.707f, -0.707f),
		float3(0.0f, 0.707f, -0.707f),
		float3(0.0f, -0.707f, 0.707f),
		float3(0.0f, 0.707f, 0.707f)
	};

	static uint gIndexData[48] = 
	{
...
void GizmoSphereRenderer::Render(RenderParam& param, int instances)
{
	ObjectConstants objectConstants;
	Matrix4x4 worldTransform = XMMatrixScaling(m_radius, m_radius, m_radius) * XMMatrixTranslation(m_offset.x, m_offset.y, m_offset.z) * XMLoadFloat4x4(&m_transformCache);
	...
	param.CommandList->DrawInstanced(48, instances, 0, 0);
}

void GizmoSphereRenderer::BuildPipelineState()
{
