...
private:
	...
	float m_cinematicViewFactor = 0.0f;
...
public:
	...
	void SetPlayerWeapon(int weaponID, bool sendPacket);
	void SetPlayerArmor(int armorID, bool sendPacket);
	...
	void SetCinematicViewTarget(const std::shared_ptr<SceneObject>& target, float duration, bool fadeIn);
